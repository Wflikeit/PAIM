...
describe("CheckoutPage", () => {
    ...
    it("places an order successfully when fields are valid", async () => {
        (placeOrder as jest.Mock).mockResolvedValueOnce({ message: "Order placed successfully" });
        ...
        const deliveryDate = new Date(2025, 0, 5); // A valid date not in busyDays
        fireEvent.click(screen.getByText(/5/i)); // Simulate selecting the date in the calendar
