...
class ProductService:
    ...
    def get_product(self, product_id: str):
        product = self._product_repo.get_product_from_db(product_id)
        product_info = {}
    ...
    def get_image(self, product_id: str) -> Optional[StreamingResponse]:
        ...
        if product:
            image_data = self._product_repo.get_image_from_db(product["imageId"])

            image_response = StreamingResponse(image_data, media_type="image/jpeg", headers={
